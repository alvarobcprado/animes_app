...
abstract class AppColors {
  ...
  static const Color onLightBackground = Color(0xFF1A1C1E);

  static const Color darkSurface = Color(0xFF1A1C1E);
  static const Color onDarkSurface = Color(0xFFE3E2E6);
  static const Color darkError = Color(0xFFFFB4AB);
  static const Color onDarkError = Color(0xFF690005);
  static const Color darkBackground = Color(0xFF1A1C1E);
  static const Color onDarkBackground = Color(0xFFE3E2E6);
}
